...
//        directly of type T
//@MainThread
//inline fun <reified T, reified VM : TypedViewModel<T>, F> F.viewModel(params: T): Lazy<VM> where F : DIAware, F : Fragment {
//    return lazy {
//        ViewModelProvider(this, direct.instance(VM::class.java, params)).get(VM::class.java)
//    }
//}
...
//        directly of type T
//@MainThread
//inline fun <reified T, reified VM : TypedViewModel<T>, F> F.sharedActivityViewModel(params: T): Lazy<VM> where F : DIAware, F : Fragment {
//    return lazy {
