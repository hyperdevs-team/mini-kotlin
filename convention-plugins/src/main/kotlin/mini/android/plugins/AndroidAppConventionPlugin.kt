...
import mini.android.plugins.extensions.applyAndroidAppVersioning
...
class AndroidAppConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            val (versionName, versionCode) = applyVersioning()
            applyAndroidAppVersioning(versionName, versionCode)
        }
    }
}
