...
internal class KspReducersStoreTest {
    ...
    @Test
    fun `pure reducers are called through ksp generated registry`() {
        runBlocking {
            dispatcher.dispatch(KspAnyAction("changed"))
